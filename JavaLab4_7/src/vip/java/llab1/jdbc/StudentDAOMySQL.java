...
private static final String SQL_SELECET_BY_GROUPS = "SELECT * FROM students WHERE groups = ?";
...
public List<Student> getByGroup(Connection connection, String group) throws
SQLException {

PreparedStatement prStatement = connection.prepareStatement(SQL_SELECET_BY_GROUPS);
...
private void setUpdateStatementParameters(Student student, PreparedStatement
...
private void setInsertStatementParameters(Student student, PreparedStatement
prStatement) throws SQLException {
