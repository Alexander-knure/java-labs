...
import java.io.File;
/*
 * 6. Паттерн Strategy. Разработать модель выбора способов сортировки 
 * и поиска максимального/минимального значения массива числовых объектов.
 */
public class RunPattern{
    public static void main(String [] arguments){
        System.out.println("Example for the Strategy pattern");
        System.out.println();
        System.out.println("This code uses two Strategy classes, NameSummarizer"+
                                                     " and OrganizationSummarizer,");
        System.out.println(" to provide a sorted, summarized list for"+
                                            "a ContactList. The ContactList object");
        System.out.println(" maintains a collection of Contacts, and delegates"+
                                                        " the task of representing");
        System.out.println(" its information to an associated object which "+
        ...
        System.out.println(" and sorts the list by last name, followed by the "+
                                                                         " first)");
        ...
        System.out.println(" and last name. It sorts by the organization, "+
