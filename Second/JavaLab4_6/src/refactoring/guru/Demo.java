...
import refactoring.guru.Order;
import refactoring.guru.PayByCreditCard;
import refactoring.guru.PayByPayPal;
import refactoring.guru.PayStrategy;
...
public class Demo {
	...
	public static void main(String[] args) throws IOException {
		while (!order.isClosed()) {
			...
			// process a payment.
			// Объект заказа делегирует сбор платёжных данны стратегии,
